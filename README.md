## vrpn (jazzy) - 7.35.0-18

The packages in the `vrpn` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy vrpn` on `Sun, 19 May 2024 18:12:44 -0000`
